...
class ExclMemberEditSectionHeader: UICollectionReusableView, Reusable {
    ...
    func configure(item: ExclMemberEditSection, sectionIndex: Int) {
    ...
    func deleteSectionRelatedExclItem(item: ExclMemberEditSection) {
