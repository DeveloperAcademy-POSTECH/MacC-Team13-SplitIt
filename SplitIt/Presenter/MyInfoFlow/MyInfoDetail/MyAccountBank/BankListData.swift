...
struct BankListData {
    var bankList: Observable<[Bank]> {
        return Observable.just([
            ...
            Bank(backIdx: 26, name: "BOA"),
            Bank(backIdx: 27, name: "중국은행"),
            Bank(backIdx: 28, name: "HSBC은행"),
            Bank(backIdx: 29, name: "중국공상"),
            Bank(backIdx: 30, name: "도이치은행"),
            Bank(backIdx: 31, name: "JP모간체이스은행"),
            Bank(backIdx: 32, name: "BNP파리바은행"),
            Bank(backIdx: 33, name: "중국건설은행"),
            Bank(backIdx: 34, name: "뱅크오브아메리카")
        ])
    }
