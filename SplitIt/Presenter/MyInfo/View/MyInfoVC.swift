...
class MyInfoVC: UIViewController {
    ...
    private let accountEditBtn = UIButton()
    ...
    func setBinding() {
        ...
        let input = MyInfoVM.Input(accountEditBtnTapped: accountEditBtn.rx.tap.asDriver(),
                                   privacyBtnTapped: privacyBtn.rx.tap.asDriver(),
    ...
    func setAddView() {
        ...
        [userNameLabel, userName, userBar, accountInfoLabel, accountEditBtn, accountBankLabel, accountLabel,socialPayLabel, tossPayBtn, tossPayLabel, kakaoPayBtn, kakaoPayLabel, naverPayBtn, naverPayLabel].forEach {
...
//
        ...
        accountEditBtn.do {
            $0.setAttributedTitle(accountEditBtnString, for: .normal)
    ...
    func setLayout() {
        ...
        accountEditBtn.snp.makeConstraints { make in
            make.top.equalTo(accountView.snp.top).offset(20)
            make.right.equalTo(accountView.snp.right).offset(-20)
        }
